 ...
 *
 * This script demonstrates how to send all types of alerts to Telegram
 *
 * IMPORTANT: Set TELEGRAM_BOT_TOKEN environment variable before running
 * Example: export TELEGRAM_BOT_TOKEN="your-bot-token"
 */
...
// Mock notification data with your Telegram chat ID
const mockNotification = {
  ...
  data: '{"telegram":{"chatId":"your-chat-id"}}',
};

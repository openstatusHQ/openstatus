/**
 * Twilio WhatsApp Notification Examples
 *
 * This script demonstrates how to send all types of alerts via WhatsApp using Twilio
 *
 * IMPORTANT: Set these environment variables before running:
 * - TWILLIO_ACCOUNT_ID="your-twilio-account-id"
...
// Mock notification data with your WhatsApp phone number
const mockNotification = {
  ...
  createdAt: new Date(),
  updatedAt: new Date(),
  // Replace with your WhatsApp phone number (E.164 format, e.g., +15551234567)

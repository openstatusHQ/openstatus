/**
 * PagerDuty Notification Examples
 *
 * This script demonstrates how to send all types of alerts to PagerDuty
 */
...
// Mock notification data with your PagerDuty integration key
const mockNotification = {
  ...
  createdAt: new Date(),
  updatedAt: new Date(),
  // Replace with your PagerDuty integration key(s)
  data: '{"pagerduty":"{\\"integration_keys\\":[{\\"integration_key\\":\\"your-integration-key\\"}]}"}',
};

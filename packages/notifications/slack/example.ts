 ...
 *
 * This script demonstrates how to send all types of alerts to Slack
 */
...
// Mock notification data with your Slack webhook URL
const mockNotification = {
  ...
  data: '{"slack":"https://hooks.slack.com/services/YOUR/WEBHOOK/URL"}',
};

/**
 * Ntfy Notification Examples
 *
 * This script demonstrates how to send all types of alerts to Ntfy
 */
...
// Mock notification data with your Ntfy topic
const mockNotification = {
  ...
  createdAt: new Date(),
  updatedAt: new Date(),
  // Replace with your Ntfy topic and optional token
  // For self-hosted: data: '{"ntfy":{"topic":"your-topic","serverUrl":"https://your-ntfy-server.com","token":"your-token"}}'
  data: '{"ntfy":{"topic":"your-topic"}}',
};

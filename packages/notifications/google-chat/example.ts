/**
 * Google Chat Notification Examples
 *
 * This script demonstrates how to send all types of alerts to Google Chat
 */
...
// Mock notification data with your Google Chat webhook URL
const mockNotification = {
  id: 1,
  name: "Google Chat Notification",
  provider: "google-chat" as const,
  workspaceId: 1,
  createdAt: new Date(),
  updatedAt: new Date(),
  // Replace with your Google Chat webhook URL
  data: '{"google-chat":"https://chat.googleapis.com/v1/spaces/YOUR_SPACE/messages?key=YOUR_KEY&token=YOUR_TOKEN"}',
};

/**
 * Twilio SMS Notification Examples
 *
 * This script demonstrates how to send all types of alerts via SMS using Twilio
 *
...
// Mock notification data with your phone number
const mockNotification = {
  ...
  createdAt: new Date(),
  updatedAt: new Date(),
  // Replace with your phone number (E.164 format, e.g., +15551234567)

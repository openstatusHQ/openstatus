-- Rename monitor_group to page_groups
ALTER TABLE `monitor_group` RENAME TO `page_groups`;--> statement-breakpoint

-- Create page_component table
...
-- Create maintenance_to_page_component junction table

...
INSERT INTO monitorNEW ( job_type, periodicity, status, active, regions, url, name, description, headers, body, method, workspace_id, created_at, updated_at) SELECT job_type, periodicity, status, active, regions, url, name, description, headers, body, method, workspace_id, created_at, updated_at FROM monitor; --> statement-breakpoint

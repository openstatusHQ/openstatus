...
CREATE INDEX `oauth_grant_client_id_idx` ON `oauth_grant` (`client_id`);--> statement-breakpoint
CREATE INDEX `oauth_grant_previous_refresh_token_hash_idx` ON `oauth_grant` (`previous_refresh_token_hash`);
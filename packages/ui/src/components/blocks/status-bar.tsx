    ...
    return (
      <HoverCard openDelay={0} closeDelay={0} open={isActive}>
        <HoverCardTrigger asChild>
          <div
            ref={ref}
            className="group focus-visible:ring-ring/50 relative flex h-full flex-1 cursor-pointer flex-col rounded-(--radius) outline-none hover:opacity-80 focus-visible:opacity-80 focus-visible:ring-[2px] aria-pressed:opacity-80"
            onClick={() => handlers.onClick(index)}
            onFocus={() => handlers.onFocus(index)}
          ...
          >
            <div className="flex h-full w-full flex-col overflow-hidden rounded-(--radius)">
              {/* Render bar segments */}

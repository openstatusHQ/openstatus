...
// from nucleo-ui-outline-18 (TriangleWarning); 18px grid, so the 1.5 stroke renders as 2px at size 24
export const TriangleAlert = forwardRef<SVGSVGElement, IconProps>(

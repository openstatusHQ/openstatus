...
export enum HttpAssertionComparator {
   ...
   * HTTP_ASSERTION_COMPARATOR_GREATER_THAN checks if value is greater than.
   *
   * @generated from enum value: HTTP_ASSERTION_COMPARATOR_GREATER_THAN_EQUALS = 6;
   */
   ...
   *
   * @generated from enum value: HTTP_ASSERTION_COMPARATOR_LESS_THAN = 7;
   */
  LESS_THAN = 7,

  /**
   * HTTP_ASSERTION_COMPARATOR_LESS_THAN_EQUALS checks if value is less than or equal to.
   *
   * @generated from enum value: HTTP_ASSERTION_COMPARATOR_LESS_THAN_EQUALS = 8;
   */
  LESS_THAN_EQUALS = 8,
}

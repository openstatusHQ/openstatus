...
export const themeStylePropsSchema = z.object({
  ...
  success: z.string().optional().describe("Color for success states."),
  warning: z.string().optional().describe("Color for warning states."),
  info: z.string().optional().describe("Color for informational states."),

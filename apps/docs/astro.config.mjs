						...
						items: [
							...
							},
							{
								...
								items: [
									...
									{ label: "Subscribers", slug: "status-page/status-page-subscribers" },
									{ label: "Reports", slug: "status-page/status-report" },

									{ label: "Widget", slug: "status-page/status-widget" },
									{ label: "Customization", autogenerate: { directory: 'status-page/customization' }, collapsed: true }
							...
							{ label: "Incidents", autogenerate: { directory: "incident" } },
							{
								...
								items: [
									{ label: "Overview", slug: "alerting/overview" },
									{
										...
										autogenerate: { directory: "alerting/providers", collapsed: true },
									},
								],
							},
							{

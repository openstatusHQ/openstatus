...
sidebar_label: "How to set up the Slack Agent"
---
...
<Callout>Make sure you select the correct Slack workspace if you belong to multiple workspaces.</Callout>
...
<Callout type="info">The bot only responds when mentioned with `@openstatus` — it won't interrupt your conversations.</Callout>

...
sidebar_label: "Get Started with OpenStatus CLI"
---
...
![openstatus CLI in action showing monitor management](/images/tutorial/get-started-with-openstatus-cli/CLI.png)
...
<Callout>Add this to your shell profile (`~/.bashrc`, `~/.zshrc`) to persist across sessions.</Callout>

...
sidebar_label: "How to configure a status page"
---
...
![Create your status page](/images/tutorial/configure-status-page/configure-status-page-1.png)
...
![Status page floating configuration popover](/images/tutorial/configure-status-page/status-page-floating.png)


---

<Callout>Once enabled, the subdomain will have a rewrite to the new project. We are adding a `maxAge: 600` request cookie to improve the page load. **If you decide to deactivate the new version, it might take up to 10 minutes for the user to see the old page.**</Callout>
...
![absolute bar type with duration card and showing uptime](/images/tutorial/configure-status-page/status-page-beta-3.png)

Example of **absolute bar** with **request card** and **hiding uptime**

![absolute bar type with request card and hiding uptime](/images/tutorial/configure-status-page/status-page-beta-4.png)

Example of **manual bar** with **simple card** and **hiding uptime**

![manual bar type and hiding uptime](/images/tutorial/configure-status-page/status-page-beta-2.png)
...
![Header navigation of your status page](/images/tutorial/configure-status-page/status-page-beta-1.png)
...
<iframe src="https://www.youtube.com/watch?v=igMbSrej6RQ" title="View, configure and enable the new status page" width="100%" height="400" allowFullScreen />

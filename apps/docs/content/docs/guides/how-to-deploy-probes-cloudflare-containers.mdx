...
sidebar_label: "How to deploy probes on Cloudflare Containers"
---
...
![Cloudflare Workers Logs showing openstatus Private Location running](/images/guides/how-to-deploy-probes-cf-containters/cloudflare-log.png)

![openstatus Private Location connected](/images/guides/how-to-deploy-probes-cf-containters/private-location.jpg)

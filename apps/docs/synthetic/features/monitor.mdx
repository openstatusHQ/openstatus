...
If the check fails, a <a href="/synthetic/features/notification">notification</a> is triggered and an <a href="/synthetic/features/incident">incident</a> is created.

...
Make sure you have the necessary permissions to execute the request. If you're sure you have the necessary permissions, check the request by debugging or logging it and making sure it's correct. You might want to upgrade your workspace plan.

---
title: How to configure a status page?
description: "How to configure a status page"
---
...
<Aside>Newly created pages will automatically run on the new version. For old pages, this is an **opt-in toggle**. We will keep the current status page until next year to allow you migrate or provide any feedback.</Aside>

You can always have a look how your status page will look like via `https://[slug].stpg.dev`.

Example: [https://themes.openstatus.dev/status](https://themes.openstatus.dev/status)

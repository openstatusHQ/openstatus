...
<Image src={ConfigureStatusPage1} alt="Create your status page" />
...
<Aside>
  Once enabled, the subdomain will have a rewrite to the new project. We are
  adding a `maxAge: 600` request cookie to improve the page load. **If you
  decide to deactivate the new version, it might take up to 10 minutes for the
  user to see the old page.**
</Aside>
...
<Image src={StatusPageBeta2} alt="manual bar type and hiding uptime" />
...
<Image src={StatusPageBeta1} alt="Header navigation of your status page" />

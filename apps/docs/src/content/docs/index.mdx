...
<CardGrid >
    ...
    <LinkCard title="💡 Explanations"   href="/concept/getting-started/" description="In-depth explanations of key concepts, design decisions, and best practices." />
    <LinkCard title="📖 Reference"  href="/reference.mdx" description="Technical specifications, API documentation, and configuration references." />
</CardGrid>

...
If you want to self host openstatus, we provide a [docker-compose](https://www.github.com/) file to get you started quickly.
...
12. Deploy the private location to your cloud provider of choice with they API key

...
How-to guides are **goal-oriented recipes** that help you accomplish specific tasks. Unlike tutorials, they assume you're already familiar with OpenStatus basics and want to solve a particular problem.

### When to use how-to guides

Choose a how-to guide when you:
- Need to accomplish a specific task
- Want to integrate OpenStatus with other tools
- Are looking for solutions to common challenges
...
- **[Reference](/reference.mdx)** - For detailed technical specifications

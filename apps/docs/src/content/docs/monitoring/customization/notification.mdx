...
<Image src={Notification} alt="Monitor notifications" />
...
<Aside>
  By default your monitor won't send any notification on failure. You can enable
  notifications for your monitor by connecting it to a notification channel.
</Aside>

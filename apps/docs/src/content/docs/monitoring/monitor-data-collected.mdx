...
<Image src={ResponseLog} alt="openstatus response log" />
...
<Image src={ResponseLogHeader} alt="openstatus response log" />
...
- **Transfer timing**: The time taken to download the response body.
  ...
  <Image src={ResponseLogTiming} alt="openstatus response log timing" />

...
You can create monitors in our dashboard, with the <a href="https://api.openstatus.dev/v1#tag/monitor/POST/monitor">API</a> or with <a href="/tools/terraform">Terraform</a>.

...
import monitorOverview from '../../../assets/monitor/create-monitor/monitor-overview.png';
import createMonitor from '../../../assets/monitor/create-monitor/create-monitor-1.png';
import createMonitor2 from '../../../assets/monitor/create-monitor/create-monitor-2.png';

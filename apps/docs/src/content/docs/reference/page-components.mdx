...
**Migration:** Existing status pages using the legacy system will continue to function. We recommend updating your status pages to use page components for improved flexibility and future compatibility.

...
Manage openstatus from your own scripts, infrastructure, or AI assistants:

<CardGrid>
  <LinkCard title="REST API" href="https://api.openstatus.dev/openapi" description="Full REST API reference with interactive examples" />
  <LinkCard title="CLI" href="/reference/cli-reference" description="Manage monitors and pages from the command line" />
  <LinkCard title="MCP Server" href="/reference/mcp-server" description="Connect Claude, Cursor, and other AI assistants via Model Context Protocol" />
</CardGrid>

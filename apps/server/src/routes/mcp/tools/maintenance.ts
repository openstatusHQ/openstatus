...
export function registerMaintenanceTools(
  ...
  const t_listMaintenances = registerScopedTool(
    server,
    ctx,
    "list_maintenances",
    {
  ...
  if (t_listMaintenances)
    registered.set("list_maintenances", t_listMaintenances);

  const t_createMaintenance = registerScopedTool(
    server,
    ctx,
    "create_maintenance",
    {
  ...
  if (t_createMaintenance)
    registered.set("create_maintenance", t_createMaintenance);

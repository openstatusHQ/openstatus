...
export function registerStatusReportTools(
  ...
  const t_listStatusReports = registerScopedTool(
    server,
    ctx,
    "list_status_reports",
    {
  ...
  if (t_listStatusReports)
    registered.set("list_status_reports", t_listStatusReports);

  const t_createStatusReport = registerScopedTool(
    server,
    ctx,
  ...
  if (t_createStatusReport)
    registered.set("create_status_report", t_createStatusReport);

  const t_addStatusReportUpdate = registerScopedTool(
    server,
    ctx,
  ...
  if (t_addStatusReportUpdate)
    registered.set("add_status_report_update", t_addStatusReportUpdate);

  const t_updateStatusReport = registerScopedTool(
    server,
    ctx,
  ...
  if (t_updateStatusReport)
    registered.set("update_status_report", t_updateStatusReport);

  const t_resolveStatusReport = registerScopedTool(
    server,
    ctx,
  ...
  if (t_resolveStatusReport)
    registered.set("resolve_status_report", t_resolveStatusReport);

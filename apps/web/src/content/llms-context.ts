...
- **Pro** — $100/month: 50 monitors, 28 regions, 30s check interval, 5 status pages, 50 components, password-protected pages, White Label add-on, 12-month retention, private locations, OTel exporter, 20 notification channels

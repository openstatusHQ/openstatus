...
We’ve also added a **right-hand sidebar** with additional information about the page you’re viewing. This allows us to hide details while making them visible when needed - inspired by Axiom.

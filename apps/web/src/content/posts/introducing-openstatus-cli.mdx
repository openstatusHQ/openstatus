...
As developers, we live in the terminal, sometimes we are even stuck trying to quit NeoVim. At Openstatus, we understand that deeply. That's why we're thrilled to announce the release of the Openstatus Terminal, a powerful new tool designed to bring your monitoring workflow directly into the environment you love.
...
We're incredibly excited about the Openstatus Terminal and believe it will fundamentally change how you interact with your monitoring. It's a significant step towards a more integrated, efficient, and developer-friendly monitoring experience.

Ready to take your monitoring to the next level? Head over to our [documentation](https://docs.openstatus.dev/cli/getting-started/) to learn how to install and start using the Openstatus Terminal today. We can't wait to hear what you think of it.

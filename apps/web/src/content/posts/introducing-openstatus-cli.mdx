...
Ready to take your monitoring to the next level? Head over to our [documentation](https://docs.openstatus.dev/cli/getting-started/) to learn how to install and start using the openstatus CLI today. We can't wait to hear what you think of it.

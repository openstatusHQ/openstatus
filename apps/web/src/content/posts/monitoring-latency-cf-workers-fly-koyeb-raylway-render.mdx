...
We can see that Johannesburg takes about 10 times longer than the other
monitors.
...
Our request follows this route:
...
Picking a cloud provider is not only about latency. It’s also about the DX. We

...
limitation. It was shamelessly copied from our competitors, who all use per seat
pricing, and many other SaaS businesses.
...
It will be one of our advantages compared to our competitors. We want more teams
to use our product.
...
will tell you to remove the free plan. It's a waste of time.
...
Our pricing is not static. If we see that it's not working, we will change it.

...
In before we have grandfathered all our existing users to the previous pricing, so this update only affects new users.
...
Initially, I don't know why we were using prices ending in 9, but it's a common practice accross all industry.

The psychology behind pricing is fascinating. Research by [Paddle](https://www.paddle.com/blog/end-prices-in-9s) reveals that while prices ending in 9 can boost sales, they're often associated with discount brands or perceived as a marketing ploy. By embracing round numbers, we're making a statement about our product's quality and value. We're not trying to create an illusion of a bargain; instead, we're confidently presenting our true worth.

## 🌍💰 Us vs. Our Competitors: More Regions, Lower Price

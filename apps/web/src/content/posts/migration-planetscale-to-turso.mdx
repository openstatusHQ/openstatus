...
### SQLite has less a less powerful type system than MySQL. 📦
...
when we realeased the incident:
...
However, I have DMed [Glauber Costa](https://twitter.com/glcst), the CEO of
Turso, and they are aware of this issue. Hopefully, they will update the
documentation soon. I believe that with comprehensive documentation and plenty
of examples, Turso will be an even great product.

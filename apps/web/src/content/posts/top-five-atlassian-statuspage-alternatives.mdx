...
If you need help along the way, feel free to join our [Discord community](https://openstatus.dev/discord), check our [documentation](https://docs.openstatus.dev) for more information or reach out to us via [email](mailto:ping@openstatus.dev)

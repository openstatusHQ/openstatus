---
title: Vision 2025
description: Our plans for OpenStatus in 2025.
author:
...
Moving forward, we want to embrace standards like **OpenTelemetry.** 

We believe the current ecosystem is broken you can not build a observability tool isolated from the rest of the observability stack 
...
But there’s more. As developers, we live in our IDEs and terminals. That’s why we really want improve our **openstatus CLI** and a `config.openstatus.yaml` to make developer experience neat (DX). Allowing you to run your synthetic check in you CI workflow, or from your terminal.

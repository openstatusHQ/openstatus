...
As an example we have deployed a Private Location on [Max's Raspberry Pi](/blog/deploy-private-locations-raspberry-pi) at home, and on [Cloudflare containers](https://www.openstatus.dev/docs/guides/how-to-deploy-probes-cloudflare-containers/)

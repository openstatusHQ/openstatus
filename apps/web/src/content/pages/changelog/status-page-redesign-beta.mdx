...
Read more within our [documentation](https://www.openstatus.dev/docs/guides/how-to-configure-status-page/) and see how your page will look like by going to `[slug].stpg.dev` (e.g. [status.stpg.dev](https://status.stpg.dev)).

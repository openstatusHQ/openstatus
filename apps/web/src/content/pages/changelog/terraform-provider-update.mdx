...
Check out the [Terraform provider reference](https://www.openstatus.dev/docs/reference/terraform/) for full documentation and examples, or follow the [guide](https://www.openstatus.dev/docs/guides/how-to-manage-openstatus-with-terraform-cli) to set up your monitoring stack from scratch.

...
Ready to take your monitoring to the next level? Head over to our [documentation](https://www.openstatus.dev/docs/tutorial/get-started-with-openstatus-cli/) to learn how to install and start using the openstatus CLI today.

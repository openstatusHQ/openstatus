...
If you want more detail on the API setup or what each field maps to, we have a step-by-step guide in our docs: [How to Import a Status Page](https://www.openstatus.dev/docs/guides/how-to-import-status-page).

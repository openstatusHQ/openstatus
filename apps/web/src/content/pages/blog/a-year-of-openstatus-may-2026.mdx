...
March 2025: ~7,000 GitHub stars. We didn't feel particularly unique. We weren't sure what to charge for. We were marketing "open source" even though our own product was hard to self-host. We were chasing stars. We were not talking to our users. We were lost.
...
**Tone of the retrospective:** honest, slightly self-deprecating, dev-to-dev. The register of the [Reality Check post](/blog/product-strategy-a-reality-check): *"Spoiler alert: it's been hard, really hard."* If a sentence wouldn't feel uncomfortable to read out loud, it's not honest enough yet.
...
- **Showed up in the community.** Slack and Discord stopped being a ticket queue and became the room. We reply fast. We ship fast. Users tell us, repeatedly and unprompted, that this is the thing they appreciate most. It also happens to be the part of the week we enjoy the most. Power contributors like [Moulik](https://www.linkedin.com/in/agg-moulik/) took it a step further than feedback: he's been hugely supportive and shipped features like status-page i18n or importers.
...
**Before:** We marketed "open source" but couldn't really be self-hosted. [The Reality Check post](/blog/product-strategy-a-reality-check) said it out loud: *"We're not great at maintaining our self-hosted product."*
...
**The community side of OSS:** We've also stopped treating Slack and Discord as overflow. The channels are where we hang out. Feature requests turn into PRs. Bug reports turn into same-day fixes. People drop into the Discord to ask a setup question and stick around to help the next person. We're not a big team (two founders, one intern, and Alex on design), so being responsive is one of the few real advantages we have. We use it.

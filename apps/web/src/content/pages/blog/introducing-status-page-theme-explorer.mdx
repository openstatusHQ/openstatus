...
To try the new experience on your own status page, **opt in to the redesign (beta)** ([Guide: How to configure a status page](https://www.openstatus.dev/docs/guides/how-to-configure-status-page/)) and select your preferred theme. Newly created pages will automatically opt in to the new theme.
...
[Concepts > Status Values and Uptime Calculation](https://www.openstatus.dev/docs/concept/uptime-calculation-and-values/) - where we explain how these values are derived, including details about the default _“absolute”_ type (which takes duration and request values to aggregate the uptime data).

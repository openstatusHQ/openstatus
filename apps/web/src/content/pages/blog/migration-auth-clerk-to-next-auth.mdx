...
<Image
  alt="Pilcrow's tweet about the direction of the project"
  src="/assets/posts/migration-auth-clerk-to-next-auth/plicrow-comment.png"
/>

_Read the [original tweet](https://x.com/i/web/status/1785701672012107841) on X._

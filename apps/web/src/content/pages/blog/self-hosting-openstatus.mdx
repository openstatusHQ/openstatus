...
Give the updated [self-hosting guide](/docs/guides/self-hosting-openstatus) a spin and let the team know how it works for your setup! If you only want the status page and not the monitoring stack, there's a [lightweight status-page-only setup](/docs/guides/self-host-status-page-only) that runs four services instead of the full platform.

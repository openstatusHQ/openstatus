---
title: "Openstatus Component Registry"
...
See the [complete example](https://github.com/openstatusHQ/openstatus/tree/main/apps/web/src/app/(landing)/test-highlighter) for full source code and usage patterns.
...
- [Complete Example](https://github.com/openstatusHQ/openstatus/tree/main/apps/web/src/app/(landing)/test-highlighter) - See all components in action
...
- [Theme Explorer](https://themes.openstatus.dev)
...
- [Send an email](ping@openstatus.dev)

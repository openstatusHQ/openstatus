...
- **DNS and custom domain.** If your Better Stack status page used a custom domain, update your DNS records to point to openstatus. See the [docs guide](https://www.openstatus.dev/docs/guides/how-to-import-status-page) for instructions on configuring custom domains.
...
Watch a full migration from Better Stack to openstatus in real time.

<ShowcaseYouTube
  entries={[
    {
      href: 'https://www.youtube.com/embed/6nX-qjzAInU',
      title: 'Migration speedrun: Better Stack to openstatus',
    },
  ]}
/>
...
<Details summary="Can I import my Better Stack monitors into openstatus?">
...
<Details summary="Does openstatus import Better Stack subscribers?">
...
<Details summary="What if I don't have a Better Stack status page?">
...
<Details summary="How are Better Stack regions mapped to openstatus?">

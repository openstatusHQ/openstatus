...
faq:
  - question: "How much does a status page cost?"
    answer: "It ranges from free to $349/month depending on what you need. Free tiers exist at openstatus, Instatus and Better Stack but are limited to a public page and a handful of components. A private, branded page on a custom domain starts at $50/month with Instatus, $99/month with Atlassian Statuspage, $100/month with openstatus (Pro plan), and $349/month with Status.io. Per-seat charges and monitoring are extra almost everywhere except openstatus, where the $100 already includes monitoring and unlimited seats."
  ...
  - question: "Which status page provider is cheapest?"
    answer: "For a public page with no private access and a small component count, the free tiers at openstatus, Instatus and Better Stack all cost nothing. Once you need a private page, a custom domain, more than a couple of seats, and monitoring behind it, openstatus Pro at $100/month is usually the lowest total because seats are unlimited and monitoring is included rather than billed separately. If monitoring is already solved elsewhere and you need few seats, Instatus at $50/month is the cheaper private page."
...
| Private Status Page | $100/m (Pro plan, includes monitoring) | $99/m | $50/m | Add-on $42/m | ✅ | $349/m |
| Team Members | Unlimited | $20+/seat | 25 on $50/m | $29/seat | $42/seat | 50 on $349/m |
| Open-Source | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Self-Hosting | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ |

Prices reflect publicly listed plans at time of writing and change frequently — always confirm with the vendor. Private status pages on openstatus are part of the **Pro plan ($100/m)**, not an add-on: that price also covers 50 monitors, 5 status pages, unlimited team members and the monitoring behind the page. The $30/m Starter plan is for public pages only.
...
openstatus is **$30/month for a public page** and **$100/month (Pro) for a private page**, with unlimited team members and monitoring included at both tiers. For a private page, compare that $100 to:
...
On list price alone Instatus is cheaper for a private page. Add the seats and the separate monitoring bill and, for teams of 5+, openstatus Pro is typically the lowest total that also includes monitoring: Atlassian is $199+ for five seats before monitoring, Betterstack is $187 with the private-page add-on, and Status.io is $349.

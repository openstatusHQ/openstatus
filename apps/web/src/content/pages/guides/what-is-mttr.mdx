...
MTTR is the average time it takes your team to recover from an incident. Detection to restored service, divided by the number of incidents.

It's the headline metric for how good a team is at handling outages. It's also one of the most-confused metrics in the industry, because there are four different MTT-acronyms that all sound similar and get used interchangeably.

Here's what each one actually measures and how to use them without screwing up.

...
<Details summary="Do customers need an openstatus account to receive updates?">
...
<Details summary="What is Slack Connect?">
...
<Details summary="Do we need to create a new channel for each customer?">
...
<Details summary="Can customers change the components they are subscribed to?">
...
<Details summary="What if a customer's entitlement changes?">
...
<Details summary="Does Slack Connect cost customers anything?">

No. Slack Connect is free for both sides as long as at least one of the two workspaces is on a paid Slack plan.

</Details>

<Details summary="What about email or webhook subscriptions?">

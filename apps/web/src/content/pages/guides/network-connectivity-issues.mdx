...
<Details summary="How do I identify which region or users are affected?">
...
<Details summary="Should I provide a workaround like a direct IP address?">
...
<Details summary="What if my CDN provider is having issues but hasn't acknowledged it?">

...
<Details summary="Why do companies need a status page?">
...
<Details summary="What's the difference between a public and private status page?">
...
<Details summary="What should a status page include?">
...
<Details summary="Should my status page be on a separate domain?">
...
<Details summary="How often should I update a status page during an incident?">
...
<Details summary="Do small companies need a status page?">
...
<Details summary="What's the difference between a status page and a monitoring tool?">

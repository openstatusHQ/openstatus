...
A status page is a public web page that tells your users whether your service is working right now. Uptime, ongoing incidents, scheduled maintenance, and historical reliability - all in one place.

It exists for one reason: when something breaks, users need to know if the problem is on your end or theirs. Without a status page, you find out by reading your support inbox the next morning.

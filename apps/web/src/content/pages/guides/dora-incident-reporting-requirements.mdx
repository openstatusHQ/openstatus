---
title: "DORA Incident Reporting: The 4h/24h/72h Clock and the Duty to Inform Clients"
description: "DORA's major ICT incident reporting timelines, how classification triggers the clock, the separate Article 19(3) obligation to inform clients, and the parts of the regulation no monitoring tool addresses."
author: "openstatus"
...
- [Status pages for crypto and financial services](/use-case/crypto) — if you are a CASP or token issuer

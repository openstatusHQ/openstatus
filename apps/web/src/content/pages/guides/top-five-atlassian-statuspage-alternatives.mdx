...
| --- | --- | --- | --- | --- | --- |
| **Status Page** |  |  |  |  |  |
| Private Status Page | $100/m (Pro plan) | $349/m | ✅ | $50/m | Add on $42/m |
...
Private status pages on openstatus are part of the **Pro plan ($100/m)**, not an add-on: that price also covers 50 monitors, 5 status pages, unlimited team members and the monitoring behind the page. The $30/m Starter plan is for public pages only.

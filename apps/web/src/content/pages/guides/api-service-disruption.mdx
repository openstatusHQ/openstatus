...
<Details summary="How often should I update users during an API disruption?">
...
<Details summary="Should I name the third-party provider causing the issue?">
...
<Details summary="What metrics should I include in API disruption updates?">
...
<Details summary="When should I use this template instead of other incident templates?">

...
<Details summary="What's the main difference between public and private status pages?">
...
<Details summary="When should I create a public status page?">
...
<Details summary="When do I need a private status page?">
...
<Details summary="Can I use auto-incidents on a private status page?">
...
<Details summary="What authentication methods are available for private status pages?">
...
<Details summary="Should auto-incidents be enabled for customer-facing pages?">

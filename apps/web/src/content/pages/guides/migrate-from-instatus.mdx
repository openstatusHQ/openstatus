...
Watch a full migration from Instatus to openstatus in real time.

<ShowcaseYouTube
  entries={[
    {
      href: 'https://www.youtube.com/embed/fSEBm2QTgto',
      title: 'Migration speedrun: Instatus to openstatus',
    },
  ]}
/>
...
<Details summary="How does the Instatus import handle component groups?">
...
<Details summary="Are Instatus webhook and Slack subscribers imported?">
...
<Details summary="How are Instatus maintenance windows imported?">

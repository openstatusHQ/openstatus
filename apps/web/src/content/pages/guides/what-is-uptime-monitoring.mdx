...
Uptime monitoring is the practice of continuously checking, from outside your own infrastructure, whether your service is reachable and responding correctly. It's how you find out about outages before your customers do.

The premise is simple: send a request to your endpoint every minute, check the response, alert if something's wrong. The interesting parts are in the details - what you check, how often, from where, and what counts as "wrong."

...
<Details summary="How quickly should I decide to roll back a deployment?">
...
<Details summary="Should I complete the rollback before communicating, or communicate during?">
...
<Details summary="What if the rollback doesn't fix the issue?">
...
<Details summary="Do I need a post-mortem after every rollback?">

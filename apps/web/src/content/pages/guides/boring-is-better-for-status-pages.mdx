...
<Details summary="Why should status pages be static instead of using JavaScript frameworks?">
...
<Details summary="What's wrong with using animated status indicators?">
...
<Details summary="Should I A/B test my status page?">
...
<Details summary="Why avoid external dependencies on status pages?">
...
<Details summary="What makes a status page accessible during incidents?">

...
Incident management is the process teams use to deal with unplanned service disruptions - from the moment something goes wrong to the moment you've learned enough to prevent the next one.

It covers three things in parallel: fixing the technical problem, communicating with affected users, and learning from what happened. Teams that handle incidents well do all three deliberately. Teams that don't typically focus on the first and neglect the other two.

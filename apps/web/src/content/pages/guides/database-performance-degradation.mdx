...
<Details summary="How do I decide between technical and user-friendly messaging?">
...
<Details summary="Should I share the root cause of database performance issues?">
...
<Details summary="When should I trigger a database performance incident notification?">

---
title: "SOC 2 and Your Status Page: What Auditors Actually Ask For"
description: "Which SOC 2 Trust Services Criteria a status page can evidence, which ones it cannot, and the specific artifacts an auditor will request during fieldwork."
author: "openstatus"
...
A status page is evidence for a handful of criteria. SOC 2 has over sixty points of focus across five categories. Being precise about the boundary is what makes the rest of this guide useful.
...
| A1.2 | Recover and maintain availability commitments (Availability category only) | Supporting — uptime record |
| CC1, CC3, CC5, CC6, CC8 | Control environment, risk assessment, control activities, logical access, change management | **None** |

If you carry only the Security category, a status page touches CC2.3 and parts of CC7. If you carry Availability — most infrastructure vendors do, because customers ask for it — it also feeds A1.2.

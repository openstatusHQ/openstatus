...
- At least one monitor created (see [Create Your First Monitor](/docs/tutorial/create-your-first-monitor))
...
- **[Configure Your Status Page](/docs/guides/how-to-configure-status-page)** - Customize appearance and add more features

...
| **Time** | ~10 minutes |
| **Level** | Beginner |
| **Prerequisites** | openstatus account, one status page |
...
- A status page with at least one component (see [Create a Status Page](/docs/tutorial/how-to-create-status-page))
...
- **[Set up the Slack agent](/docs/tutorial/how-to-setup-slack-agent)** — create and update status reports by talking to the openstatus bot from Slack.

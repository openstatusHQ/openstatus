...
- At least one monitor created (see [Create Your First Monitor](/docs/tutorial/how-to-create-monitor))
...
- **[Configure Your Status Page](/docs/tutorial/how-to-configure-status-page)** - Customize appearance and add more features

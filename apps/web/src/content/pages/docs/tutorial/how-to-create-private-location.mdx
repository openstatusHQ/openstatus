...
- At least one monitor already created (see [Create Your First Monitor](/docs/tutorial/how-to-create-monitor))
...
- **[Create a Monitor](/docs/tutorial/how-to-create-monitor)** — Set up more monitors to run from your private location

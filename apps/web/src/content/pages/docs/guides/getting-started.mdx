...
- **[Connect openstatus to your coding agent](/docs/guides/how-to-connect-openstatus-to-your-agent)** — give Claude Code, Codex, opencode, Cursor, or ChatGPT access through the MCP server.

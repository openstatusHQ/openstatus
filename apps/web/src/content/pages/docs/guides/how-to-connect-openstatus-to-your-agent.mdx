...
For the JSON- and TOML-configured clients, add the header to the server entry — `"headers": { "x-openstatus-key": "os_…" }` in `.mcp.json`, `opencode.json`, and `.cursor/mcp.json`, or `env_http_headers = { "x-openstatus-key" = "OPENSTATUS_API_KEY" }` in `.codex/config.toml`. In a committed file, read the key from the environment so it never lands in version control:
...
- [Connect openstatus to Claude Code](https://www.openstatus.dev/guides/connect-openstatus-to-claude-code)
- [Connect openstatus to Claude Desktop](https://www.openstatus.dev/guides/connect-openstatus-to-claude-desktop)
- [Connect openstatus to Codex](https://www.openstatus.dev/guides/connect-openstatus-to-codex)
- [Connect openstatus to opencode](https://www.openstatus.dev/guides/connect-openstatus-to-opencode)
- [Connect openstatus to ChatGPT](https://www.openstatus.dev/guides/connect-openstatus-to-chatgpt)

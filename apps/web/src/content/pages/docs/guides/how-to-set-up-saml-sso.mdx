...
| **Level** | Advanced |
| **Prerequisites** | A workspace on the **Scale** plan, workspace **owner** access, and permission to add a DNS TXT record for your domain |
...
<Aside>SSO is available on the **Scale** plan. If your subscription ends, SSO is switched off automatically and your team keeps access through GitHub and Google. Your provider configuration is retained, so re-subscribing restores it without reconnecting.</Aside>

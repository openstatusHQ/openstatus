...
<Aside>SSO is a paid add-on, available on the **Starter**, **Pro**, and **Scale** plans. If your subscription ends, SSO is switched off automatically and your team keeps access through GitHub and Google. Your provider configuration is retained, so re-subscribing restores it without reconnecting.</Aside>

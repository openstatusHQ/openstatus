...
Add monitors to your `main.tf`. We'll create three of the four types the provider supports — HTTP, TCP, and DNS. ICMP works the same way; see [`openstatus_icmp_monitor`](/docs/reference/terraform#openstatus_icmp_monitor).

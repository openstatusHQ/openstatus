...
Community themes let you restyle a status page with your own colors and design — and once merged, everyone can pick your theme from the [theme explorer](/docs/guides/how-to-configure-status-page#2-appearance). This guide walks you through designing a palette, testing it locally, and opening a pull request.

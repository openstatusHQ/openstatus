...
Monitor components display historical uptime data through status trackers. Depending on your [tracker configuration](/docs/tutorial/how-to-configure-status-page#1-tracker-configuration), you can show:
...
- **[Create Status Page](/docs/tutorial/how-to-create-status-page)** - Step-by-step tutorial on creating a status page.

...
Monitor components display historical uptime data through status trackers. Depending on your [tracker configuration](/docs/guides/how-to-configure-status-page#1-components-configuration), you can show:
...
- **Default open** — whether the group renders expanded on first load. Defaults to collapsed.
- **Components** — the page components contained within this group, ordered independently.

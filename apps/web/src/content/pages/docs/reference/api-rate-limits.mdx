...

{
  ...
  "docs": "https://www.openstatus.dev/docs/reference/api-errors#too-many-requests",
...
```json
{
  ...
  "message": "Rate limit exceeded, retry later",
  "details": [
    { "type": "google.rpc.ErrorInfo", "value": "…", "debug": { "reason": "TOO_MANY_REQUESTS", "domain": "openstatus.dev", "metadata": { "requestId": "…", "docs": "…" } } },
    { "type": "google.rpc.RetryInfo", "value": "…", "debug": { "retryDelay": "7s" } }
  ]
}
```

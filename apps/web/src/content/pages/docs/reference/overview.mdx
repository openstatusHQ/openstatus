...
- **[Notification channels](/docs/reference/notification)** — Slack, Discord, Microsoft Teams, Email, WhatsApp, Telegram, PagerDuty, OpsGenie, Google Chat, Grafana OnCall, Ntfy, and generic webhooks.

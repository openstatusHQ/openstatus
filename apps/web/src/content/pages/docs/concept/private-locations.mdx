...
As of July 2026, private locations now support:

- **Automatic incidents and notifications.** Failed checks from private locations now trigger incidents and fire notifications, with intelligent threshold logic when multiple private locations are attached to a monitor.
- **Status page display.** Monitors assigned to private locations now appear on public status pages with proper status tracking and uptime graphs.

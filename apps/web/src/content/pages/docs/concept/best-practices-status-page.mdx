...
- **[Create a status page](/docs/tutorial/how-to-create-status-page)** - Get set up in minutes.
- **[Configure your page](/docs/tutorial/how-to-configure-status-page)** - Customize its appearance to match your brand.

...
We publish an official [Terraform provider](https://registry.terraform.io/providers/openstatusHQ/openstatus/latest) that lets you manage your openstatus workspace declaratively — monitors, status pages, component groups, notifications, and private locations.

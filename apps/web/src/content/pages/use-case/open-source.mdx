...
faq:
  ...
  - question: "Can I self-host openstatus?"
    answer: "Yes. Openstatus is fully open source (AGPL-3.0) and can be self-hosted. The checker runs as an 8.5MB Docker image. You can also use the managed SaaS and keep the monitoring infrastructure off your plate."
...
<Details summary="Is openstatus free for open-source projects?">
...
<Details summary="How do open-source projects use openstatus?">
...
<Details summary="Can contributors subscribe to status updates?">

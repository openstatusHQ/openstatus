...
<Details summary="Why do API providers need a public status page?">
...
<Details summary="Can I show per-endpoint status?">
...
<Details summary="Can I use monitoring as code to manage monitors?">
...
<Details summary="How do API consumers subscribe to updates?">

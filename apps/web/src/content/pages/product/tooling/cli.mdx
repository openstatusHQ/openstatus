...
<Details summary="Is the CLI suitable for AI agents?">
...
<Details summary="Can I run the CLI in CI?">
...
<Details summary="What's the difference between the CLI's YAML config and the Terraform provider?">

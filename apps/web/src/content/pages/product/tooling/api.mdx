...
<Details summary="Should I use the SDK or call the API directly?">
...
<Details summary="Is the API REST or RPC?">

It's ConnectRPC — JSON over HTTP, but with a typed RPC contract instead of REST conventions. Every method is a POST to `/rpc/openstatus.v1.<Service>/<Method>`. You can call it from curl exactly like you'd call a REST endpoint.

</Details>

<Details summary="How do I authenticate?">
...
<Details summary="Do you publish an OpenAPI spec?">

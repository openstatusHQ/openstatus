...
<Details summary="How does the Terraform provider compare to the CLI?">
...
<Details summary="What resources does the provider expose?">
...
<Details summary="How do I migrate an existing workspace into Terraform?">
...
<Details summary="Where do I get an API token?">

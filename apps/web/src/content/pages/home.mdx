...
author: "openstatus"
description: "Open-source status page and uptime monitoring with a Terraform provider, CLI, API, and MCP server. Declare monitors in your repo. Let Claude or Cursor open and resolve incidents on a key scoped read-only or read-write, with every call in the audit log. Hosted for you, or self-host the open source stack."
category: "product"
faq:

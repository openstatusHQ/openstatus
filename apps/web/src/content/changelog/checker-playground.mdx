...
description: Test your API or website from multiple regions around the world.
image: /assets/changelog/endpoint-checker-playground.png
...
But there is more: use the `https://checker.openstatus.dev/ping/[region]`
endpoint to get the metrics by yourself.
...
Read more about the [Checker API](https://docs.openstatus.dev/api/checker) in
our docs.

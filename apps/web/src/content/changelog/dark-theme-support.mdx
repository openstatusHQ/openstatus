...
[#73](https://github.com/openstatusHQ/openstatus/pull/73) has been merged. By
default, your `system` theme is applied.

Change the theme in the footer of the website whenever you want.

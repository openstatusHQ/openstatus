    ...
    <div className="grid w-full gap-6">
      <Shell className="grid px-0 py-0 sm:grid-cols-3 md:p-0">
        ...
        >
          ...
          <FeatureTitle
            strong="From all over the world."
            regular="Get insights of the latency."
          />
        </FeatureCardContentContainer>
      ...
      <Shell className="grid h-auto px-0 py-0 md:grid-cols-3 md:p-0">
        ...
        >
          ...
          <FeatureTitle
            strong="Optimize Web Performance"
      ...
      <Shell className="grid h-auto px-0 py-0 md:grid-cols-1 md:p-0">
        ...
        >
          ...
          <FeatureTitle
            strong="Opinionated Dashboard"
            regular="Keep an overview about Uptime, P50, P75, P90, P95, P99 of your monitors."
          />
          <div className="mt-2">

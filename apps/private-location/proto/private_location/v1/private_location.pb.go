...
type HTTPMonitor struct {
	...
	DegradedAt           *int64                 `protobuf:"varint,5,opt,name=degraded_at,json=degradedAt,proto3,oneof" json:"degraded_at,omitempty"`
	...
	StatusCodeAssertions []*StatusCodeAssertion `protobuf:"bytes,8,rep,name=status_code_assertions,json=statusCodeAssertions,proto3" json:"status_code_assertions,omitempty"`
	BodyAssertions       []*BodyAssertion       `protobuf:"bytes,9,rep,name=body_assertions,json=bodyAssertions,proto3" json:"body_assertions,omitempty"`
	HeaderAssertions     []*HeaderAssertion     `protobuf:"bytes,10,rep,name=header_assertions,json=headerAssertions,proto3" json:"header_assertions,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
const file_private_location_v1_private_location_proto_rawDesc = "" +
	...
	"comparator\x18\x02 \x01(\x0e2%.private_location.v1.StringComparatorR\n" +
	"comparator\x12\x10\n" +
	"\x03key\x18\x03 \x01(\tR\x03key\"\xda\x03\n" +
	"\vHTTPMonitor\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06method\x18\x02 \x01(\tR\x06method\x12\x12\n" +
	"\x04body\x18\x03 \x01(\tR\x04body\x12\x18\n" +
	"\atimeout\x18\x04 \x01(\x03R\atimeout\x12$\n" +
	"\vdegraded_at\x18\x05 \x01(\x03H\x00R\n" +
	"degradedAt\x88\x01\x01\x12\x14\n" +
	"\x05retry\x18\x06 \x01(\x03R\x05retry\x12)\n" +
	"\x10follow_redirects\x18\a \x01(\bR\x0ffollowRedirects\x12^\n" +
	"\x16status_code_assertions\x18\b \x03(\v2(.private_location.v1.StatusCodeAssertionR\x14statusCodeAssertions\x12K\n" +
	"\x0fbody_assertions\x18\t \x03(\v2\".private_location.v1.BodyAssertionR\x0ebodyAssertions\x12Q\n" +
	"\x11header_assertions\x18\n" +
	" \x03(\v2$.private_location.v1.HeaderAssertionR\x10headerAssertionsB\x0e\n" +
	...
	"\bMonitors\x12$.private_location.v1.MonitorsRequest\x1a%.private_location.v1.MonitorsResponse\"\x00B\xff\x01\n" +
	"\x17com.private_location.v1B\x14PrivateLocationProtoP\x01Zegithub.com/openstatushq/openstatus/apps/private-location/proto/private_location/v1;private_locationv1\xa2\x02\x03PXX\xaa\x02\x12PrivateLocation.V1\xca\x02\x12PrivateLocation\\V1\xe2\x02\x1ePrivateLocation\\V1\\GPBMetadata\xea\x02\x13PrivateLocation::V1b\x06proto3"
...
var file_private_location_v1_private_location_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_private_location_v1_private_location_proto_depIdxs = []int32{
	10, // 0: private_location.v1.MonitorsResponse.monitors:type_name -> private_location.v1.HTTPMonitor
	6,  // 1: private_location.v1.Monitors.monitors:type_name -> private_location.v1.Monitor
	10, // 2: private_location.v1.Monitor.http_monitor:type_name -> private_location.v1.HTTPMonitor
	...
	7,  // 6: private_location.v1.HTTPMonitor.status_code_assertions:type_name -> private_location.v1.StatusCodeAssertion
	8,  // 7: private_location.v1.HTTPMonitor.body_assertions:type_name -> private_location.v1.BodyAssertion
	9,  // 8: private_location.v1.HTTPMonitor.header_assertions:type_name -> private_location.v1.HeaderAssertion
	3,  // 9: private_location.v1.PrivateLocationService.Monitors:input_type -> private_location.v1.MonitorsRequest
	4,  // 10: private_location.v1.PrivateLocationService.Monitors:output_type -> private_location.v1.MonitorsResponse
...
func file_private_location_v1_private_location_proto_init() {
	...
	file_private_location_v1_private_location_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}

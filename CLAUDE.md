...
- **Linting and Formatting:** The project uses oxlint for linting and oxfmt for formatting. The configurations can be found in `.oxlintrc.json` and `.oxfmtrc.json` respectively.
